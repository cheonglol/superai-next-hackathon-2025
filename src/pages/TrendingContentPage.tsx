...
const TrendingContentPage: React.FC = () => {
  ...
  const filteredHashtags = selectedCategory === 'all' 
    ...
    : trendingData.hashtags.filter(hashtag => hashtag.category === selectedCategory);
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {topic.platforms.map((platform, index) => (
                        <span
                          key={index}
                          className="px-2 py-1 bg-oxford_blue-50 text-oxford_blue-700 rounded-md text-xs font-medium"
                        >
                          {platform}
                        </span>
                      ))}
