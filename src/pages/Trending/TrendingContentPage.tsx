...
const TrendingContentPage: React.FC = () => {
  ...
  const trendingData = {
    ...
    // Trending Hashtags for F&B Business
    trendingHashtags: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-200">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center text-gray-600">
                ...
                <span className="text-sm font-medium">Total Hashtags</span>
              </div>
            </div>
            <div className="text-3xl font-bold text-gray-900 mb-2">{trendingData.topMetrics.totalHashtags}</div>
            <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-3 py-1 rounded-full w-fit">
              <TrendingUp className="w-4 h-4 mr-1" />+12% from last period
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-200">
            ...
            <div className="text-3xl font-bold text-gray-900 mb-2">{trendingData.topMetrics.totalReach}</div>
            <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-3 py-1 rounded-full w-fit">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-200">
            ...
            <div className="text-3xl font-bold text-gray-900 mb-2">{trendingData.topMetrics.avgEngagement}</div>
            <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-3 py-1 rounded-full w-fit">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-200">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center text-gray-600">
                ...
                <span className="text-sm font-medium">Viral Posts</span>
              </div>
            </div>
            <div className="text-3xl font-bold text-gray-900 mb-2">{trendingData.topMetrics.viralPosts}</div>
            <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-3 py-1 rounded-full w-fit">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.businessContent.instagram.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Followers</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.instagram.followers}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Engagement</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.instagram.engagement}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.instagram.posts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Reach</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.instagram.reach}</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.businessContent.facebook.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Followers</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.facebook.followers}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Engagement</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.facebook.engagement}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.facebook.posts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Reach</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.facebook.reach}</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.businessContent.tiktok.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Followers</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.tiktok.followers}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Engagement</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.tiktok.engagement}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.tiktok.posts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Reach</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.tiktok.reach}</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.businessContent.twitter.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Followers</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.twitter.followers}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Engagement</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.twitter.engagement}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.twitter.posts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Reach</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.businessContent.twitter.reach}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
          ...
          <div className="space-y-4">
            {trendingData.topBusinessPosts.map((post) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.customerContent.instagram.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Tagged Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.instagram.taggedPosts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Check-ins</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.instagram.checkIns}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Influencer Mentions</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.instagram.influencerMentions}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">User Content</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.instagram.userContent}</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.customerContent.facebook.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Tagged Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.facebook.taggedPosts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Check-ins</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.facebook.checkIns}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Influencer Mentions</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.facebook.influencerMentions}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">User Content</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.facebook.userContent}</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.customerContent.tiktok.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Tagged Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.tiktok.taggedPosts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Check-ins</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.tiktok.checkIns}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Influencer Mentions</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.tiktok.influencerMentions}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">User Content</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.tiktok.userContent}</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center text-sm text-emerald-800 bg-emerald-100 px-2 py-1 rounded-full">
                  <TrendingUp className="w-4 h-4 mr-1" />+{trendingData.customerContent.twitter.growth}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600">Tagged Posts</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.twitter.taggedPosts}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Check-ins</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.twitter.checkIns}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Influencer Mentions</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.twitter.influencerMentions}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">User Content</p>
                  <p className="text-xl font-bold text-gray-900">{trendingData.customerContent.twitter.userContent}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
          ...
          <div className="space-y-4">
            {trendingData.viralContent.map((post) => (
              <div key={post.id} className="flex items-start space-x-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {trendingData.trendingHashtags.map((hashtag) => (
