...
const ReviewAnalyticsPage: React.FC = () => {
  ...
  const { data, loading, error } = useReviewsData(filters);
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button 
            ...
            className="px-4 py-2 bg-oxford_blue-600 text-white rounded-lg hover:bg-oxford_blue-700"
          >
            Retry
          </button>
        </div>
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button 
              ...
              className="flex items-center px-4 py-2 bg-oxford_blue-600 text-white rounded-lg hover:bg-oxford_blue-700 transition-colors"
            >
