        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <div className="flex items-center mb-4">
              <Share2 className="w-8 h-8 text-oxford_blue-600 mr-3" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="text-3xl font-bold text-gray-900 mb-1">
              {formatNumber(socialMediaData.metrics.totalFollowers)}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="text-3xl font-bold text-gray-900 mb-1">
              {formatNumber(socialMediaData.metrics.totalReach)}
            </div>
            <div className="flex items-center text-sm text-green-600">
              <TrendingUp className="w-4 h-4 mr-1" />
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="text-3xl font-bold text-gray-900 mb-1">
              {socialMediaData.metrics.avgEngagement}%
            </div>
            <div className="flex items-center text-sm text-green-600">
              <TrendingUp className="w-4 h-4 mr-1" />
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="text-3xl font-bold text-gray-900 mb-1">
              {socialMediaData.metrics.totalPosts}
            </div>
            <div className="flex items-center text-sm text-green-600">
              <TrendingUp className="w-4 h-4 mr-1" />
              +15 from last period
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <div className="flex items-center mb-2">
                      <span className="px-2 py-1 bg-oxford_blue-100 text-oxford_blue-800 rounded-md text-xs font-medium mr-2">
                        {post.platform}
                      </span>
