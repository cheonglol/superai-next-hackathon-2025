...
const ScenarioStressTester: React.FC<ScenarioStressTesterProps> = ({ mockFinancialData, formatCurrency }) => {
  ...
  const generateProjection = (): ProjectionItem[] => {
    ...
    const seasonalFactors = [
      ...
      0.9, // Month 2 (building up)
      1.1, // Month 3 (high season)
      1.2, // Month 4 (peak season)
      1.05, // Month 5 (tapering off)
      0.9, // Month 6 (returning to normal)
      0.8, // Month 7
      0.75, // Month 8
      0.85, // Month 9
      0.95, // Month 10
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {projection.map((month: ProjectionItem) => (
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className={`text-xl font-bold ${projection.some((month) => month.runningCash < safetyBuffer) ? "text-red-600" : "text-green-600"}`}>
